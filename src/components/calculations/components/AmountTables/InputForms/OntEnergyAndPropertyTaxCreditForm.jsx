...
const OntEnergyAndPropertyTaxCreditForm = ({
  formik,
  index,
  otherAmountPath,
  pathToAmount,
  ...
  const inputs = useMemo(
    () => [
      ...
      {
        label: 'Energy Costs',
        hint: 'Enter the total amount ($) paid for eligible energy expenses by this person each year.',
    ...
    [hasUserInputs, otherAmountPath, pathToAmount, values],
  );
...
export default connect(OntEnergyAndPropertyTaxCreditForm);
